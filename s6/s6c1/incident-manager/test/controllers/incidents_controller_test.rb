...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { message: @incident.message, name: @incident.name, status: @incident.status } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { message: @incident.message, name: @incident.name, status: @incident.status } }
